...
#    global f
    ...
    i=0
    while True:
            purl = "http://www.topdrawersoccer.com/search/?area=clubplayer&genderId=f&pageNo="+str(i)
...
#                f.close()
#            
#    with open("club_female.json", 'rb+') as f:
